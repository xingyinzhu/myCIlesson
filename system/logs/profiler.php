<?php if ($_SERVER[\"REMOTE_ADDR\"] != \"127.0.0.1\") exit; ?><div id='codeigniter_profiler' style='clear:both;background-color:#fff;padding:10px;'>
...
<tr><td style='vertical-align: top;width:50%;padding:5px;color:#900;background-color:#ddd;'>HTTP_USER_AGENT&nbsp;&nbsp;</td><td style='width:50%;padding:5px;color:#000;background-color:#ddd;'>Mozilla/5.0 (Windows NT 6.1; rv:19.0) Gecko/20100101 Firefox/19.0</td></tr>
...
<tr><td style='vertical-align: top;width:50%;padding:5px;color:#900;background-color:#ddd;'>SERVER_SOFTWARE&nbsp;&nbsp;</td><td style='width:50%;padding:5px;color:#000;background-color:#ddd;'>Apache/2.2.22 (Win32) PHP/5.4.3</td></tr>
<tr><td style='vertical-align: top;width:50%;padding:5px;color:#900;background-color:#ddd;'>HTTP_ACCEPT_LANGUAGE&nbsp;&nbsp;</td><td style='width:50%;padding:5px;color:#000;background-color:#ddd;'>zh-cn,zh;q=0.8,en-us;q=0.5,en;q=0.3</td></tr>
<tr><td style='vertical-align: top;width:50%;padding:5px;color:#900;background-color:#ddd;'>SCRIPT_NAME&nbsp;&nbsp;</td><td style='width:50%;padding:5px;color:#000;background-color:#ddd;'>/CI/index.php</td></tr>
...
<tr><td style='padding:5px; vertical-align: top;color:#900;background-color:#ddd;'>base_url&nbsp;&nbsp;</td><td style='padding:5px; color:#000;background-color:#ddd;'>http://localhost/CI/</td></tr>
<tr><td style='padding:5px; vertical-align: top;color:#900;background-color:#ddd;'>server_root&nbsp;&nbsp;</td><td style='padding:5px; color:#000;background-color:#ddd;'>D:/wamp/www/</td></tr>
...
<tr><td style='padding:5px; vertical-align: top;color:#900;background-color:#ddd;'>encryption_key&nbsp;&nbsp;</td><td style='padding:5px; color:#000;background-color:#ddd;'>888888</td></tr>
...
<tr><td style='padding:5px; vertical-align: top;color:#900;background-color:#ddd;'>sess_use_database&nbsp;&nbsp;</td><td style='padding:5px; color:#000;background-color:#ddd;'></td></tr>
<tr><td style='padding:5px; vertical-align: top;color:#900;background-color:#ddd;'>sess_table_name&nbsp;&nbsp;</td><td style='padding:5px; color:#000;background-color:#ddd;'>ci_sessions</td></tr>
